...
closest_module_frame(PyFrameObject *frame)
{
    while (frame != NULL && frame->f_back != NULL && frame->f_globals != frame->f_locals) {
        frame = frame->f_back;
    }
    return frame;
}
...
/*[clinic end generated code: output=c47f86df09712f3c input=8732b3bb0236c99e]*/
{
